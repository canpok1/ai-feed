...
func (m *MockRecommender) Recommend(arg0 *entity.AIModelConfig, arg1 *entity.PromptConfig, arg2 []entity.Article) (*entity.Recommend, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recommend", arg0, arg1, arg2)
...
func (mr *MockRecommenderMockRecorder) Recommend(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recommend", reflect.TypeOf((*MockRecommender)(nil).Recommend), arg0, arg1, arg2)
}
...
func (m *MockCommentGenerator) Generate(arg0 *entity.Article) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommentGeneratorMockRecorder) Generate(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Generate", reflect.TypeOf((*MockCommentGenerator)(nil).Generate), arg0)
}
...
func (m *MockCommentGeneratorFactory) MakeCommentGenerator(arg0 *entity.AIModelConfig, arg1 *entity.PromptConfig) (domain.CommentGenerator, error) {
	m.ctrl.T.Helper()
